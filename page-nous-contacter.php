...
<div class="max-w-7xl p-4 md:p-6 lg:p-8 mx-auto flex justify-center">
    <div class="w-full max-w-2xl">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 md:p-8">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-3">
                        ...
                        <button type="button" id="contact-captcha-refresh" class="text-sm cursor-pointer text-white px-3 py-2 rounded-md bg-main hover:underline focus:outline-none focus:underline" title="<?php esc_attr_e('Rafraîchir le code', 'parisii-optique'); ?>"><?php esc_html_e('Rafraîchir', 'parisii-optique'); ?></button>
                    </div>
        ...
        <div id="parisii-contact-success" class="hidden bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 md:p-8 text-center">
            ...
            <button type="button" id="parisii-contact-refresh-btn" class="px-6 py-3 rounded-lg bg-main hover:bg-main-hover focus:bg-main-focus text-white font-medium focus:ring-2 focus:ring-main focus:ring-offset-2 dark:focus:ring-offset-gray-900 transition-colors cursor-pointer">
