...
function parisii_optique_newsletter_section_shortcode($atts, $content = null) {
    ...
    ob_start();
    ?>
    <section class="parisii-newsletter-section py-16 bg-secondary text-white <?php echo esc_attr($atts['class']); ?>">
        <div class="max-w-7xl p-4 md:p-6 lg:p-8 mx-auto">
            <div class="max-w-2xl mx-auto text-center">
                ...
                <form class="newsletter-form flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                    ...
                    <button type="submit" 
                            class="px-6 py-3 bg-white bg-secondary font-semibold rounded-lg hover:bg-gray-100 transition-colors">
